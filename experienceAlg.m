function [ newExp ] = experienceAlg( fbValue, currentExp, previousExp)
% Experience Algorithm: it calculates experience value taking feedback value (fbValue), current Exp value, and previous Exp value as inputs
